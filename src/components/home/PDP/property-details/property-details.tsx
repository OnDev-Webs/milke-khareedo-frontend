      ...
      <div className="mx-4 md:mx-auto container rounded-2xl bg-white shadow-sm">
        ...
        <div className="px-4 md:px-6 py-4">
          <div className="grid gap-6 md:grid-cols-3">
            <div className="space-y-2">
              <div>
                ...
                <p className="mt-1 text-[18px] font-medium text-[#000000]">
            ...
            <div className="space-y-2 border-t md:border-t-0 md:border-l md:border-r md:border-gray-100 md:px-6">
              <div>
                <p className="text-[14px] text-[#7B7B7B] font-normal">Configuration</p>
                <p className="mt-1 text-[18px] font-medium text-[#000000]">
          ...
          <div className="mt-4 pt-2">
            ...
            <p className="leading-relaxed mt-1 text-[18px] font-medium text-[#000000] line-clamp-2">
