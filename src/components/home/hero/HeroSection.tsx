...
export default function Hero() {
  ...
  return (
    ...
    <section className="relative w-full py-10">
      {/* ================= HERO CARD ================= */}
      <div className="max-w-6xl mx-auto relative w-full md:h-[450px] rounded-3xl bg-gradient-to-br from-[#C1DDEB] to-[#E3F2F5] p-6 shadow-md overflow-hidden">
        {/* ================= TEXT CONTENT ================= */}
        <div className="relative z-10 w-full md:w-[60%] pt-10 ps-4 md:ps-6">
          <p className="font-medium text-[#585981] mb-2">
            Buying a home is a big decision.
          </p>

          <h1 className="text-3xl md:text-4xl font-bold text-[#151516]">
            <span className="text-[#1C4692] block">Milke Khereedo</span>
            Makes it easier.
          </h1>
        ...
        <div className="hidden md:block absolute top-[-32px] right-[-80px] left-[530px]">
          <div className="relative w-[600px] h-[480px]">
            <Image
              ...
              fill
              priority
              className="object-cover object-[50%_80%] scale-[1.4]"
            />
          </div>
        </div>

        <div className="block md:hidden mt-10">
          <div className="relative w-full h-[360px] sm:h-[420px] overflow-hidden rounded-2xl">
            <Image
              src="/images/banner1.png"
              alt="Hero Image"
              fill
