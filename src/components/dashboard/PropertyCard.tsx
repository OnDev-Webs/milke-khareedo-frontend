  ...
  return (
    <div className="flex flex-col rounded-4xl bg-white p-4 shadow-sm">
      ...
      <div className="mt-4 flex flex-col gap-3">
        ...
        <button className="mt-2 rounded-full bg-[#1C4692] hover:bg-[#1c4692e6] py-2 text-sm font-semibold text-white">
          View Details
        </button>
      </div>
    </div>
  ...
  return (
    <div className={`rounded-xl px-4 py-3 text-center ${className}`}>
      ...
      <p className="mt-1 text-sm">
        <span className="font-bold text-xl text-[#ff7a59]">{number}</span>{" "}
