        ...
        <div className="self-stretch flex flex-col justify-center items-start gap-3.5">
          <div className="self-stretch inline-flex justify-between items-center">
            <div className="w-full max-w-[570px] inline-flex flex-col justify-start items-start gap-5">
              <div className="self-stretch justify-start text-blue-900 text-5xl font-bold font-['Figtree']">Godrej South Estate</div>
              <div className="self-stretch justify-start text-black text-xl font-normal font-['Figtree']">Keshvas park, New Delhi, Delhi</div>
            </div>
              ...
              <div className="self-stretch flex flex-col justify-center items-center gap-2.5">
                <div className="self-stretch inline-flex justify-between items-end">
                  <div className="size- inline-flex flex-col justify-start items-start gap-2.5">
                    ...
                    <div className="justify-start text-black text-4xl font-bold font-['Figtree']">₹ 4.68 Crore</div>
                  </div>
                  <div className="self-stretch inline-flex flex-col justify-between items-end">
                    ...
                    <div className="justify-start text-neutral-600 text-2xl font-semibold font-['Figtree'] line-through">₹ 5.31 Crore</div>
                  </div>
                </div>
                ...
                <div className="self-stretch inline-flex justify-start items-center gap-2.5">
                  <div className="flex-1 px-2.5 py-1.5 bg-white rounded-[60px] inline-flex flex-col justify-center items-start gap-2.5">
                    <div className="size- inline-flex justify-center items-center gap-[5px]">
                      ...
                      <div className="text-center justify-start text-lime-600 text-sm font-medium font-['Figtree']">Up to 63.28 L off</div>
                    </div>
                  </div>
                  <div className="text-center justify-start text-red-500 text-sm font-normal font-['Figtree']">Get upto 12% discount on this property</div>
                </div>
              </div>
            </div>
          </div>
