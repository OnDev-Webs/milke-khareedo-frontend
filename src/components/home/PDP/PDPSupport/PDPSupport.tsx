    ...
    <div className="w-full rounded-3xl bg-white border border-[#F3F3F3] py-4 text-center">
      <div className="relative px-8">
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 text-[#000000] px-3">
          <svg width="57" height="57" viewBox="0 0 57 57" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1092_12078)">
      ...
      <div className="flex items-center gap-4 px-3">
        ...
        <div className="ml-auto flex items-center gap-1">
          <button
            onClick={handleCall}
            className="inline-flex items-center gap-1 rounded-full bg-[#66AE39] text-white px-2.5 py-2 text-xs font-medium hover:bg-[#5a9a32] transition-colors shadow-sm"
          >
